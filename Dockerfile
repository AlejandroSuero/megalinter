...
ARG REPOSITORY_TRUFFLEHOG_VERSION=3.81.10
...
RUN curl https://sh.rustup.rs -sSf | sh -s -- -y --profile minimal --default-toolchain stable \
    ...
    && rustup component add clippy && cargo install --force --locked sarif-fmt  shellcheck-sarif  selene@${LUA_SELENE_VERSION}  stylua@${STYLUA_VERSION} \
